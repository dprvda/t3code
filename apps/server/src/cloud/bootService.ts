...
const BOOT_SERVICE_NAME = "carbon-studio";
export const BOOT_SERVICE_UNIT_FILE = `${BOOT_SERVICE_NAME}.service`;
// `.service` suffix keeps the label distinct from the desktop app's bundle id
// (com.carbonstudio.app), so launchd and TCC records never collide.
export const BOOT_SERVICE_LAUNCHD_LABEL = "com.carbonstudio.app.service";
