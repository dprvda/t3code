  ...
  it("starts provider ingestion, provider command, checkpoint, and thread deletion reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(ClaudeSeatRotationReactor, {
            start: () => {
              started.push("claude-seat-rotation-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
        ...
        Layer.provideMerge(
          Layer.succeed(ContextRecycleReactor, {
            start: () => {
              started.push("context-recycle-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
    ...
    expect(started).toEqual([
      ...
      "claude-seat-rotation-reactor",
      "context-recycle-reactor",
      "schedule-reactor",
