...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "carbon-studio-dev" : "carbon-studio",
    legacyUserDataDirName: isDevelopment ? "Carbon Studio (Dev)" : "Carbon Studio (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "carbonstudio-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/carbon-studio-dev",
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "carbonstudio-dev" },
    { isDevelopment: false, scheme: "carbonstudio" },
