...
const APP_BASE_NAME = "Carbon Studio";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "carbon-studio-dev" : "carbon-studio";
  const legacyUserDataDirName = isDevelopment ? "Carbon Studio (Dev)" : "Carbon Studio (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.carbonstudio.app.dev" : "com.carbonstudio.app",
    ),
    linuxDesktopEntryName: isDevelopment ? "carbon-studio-dev.desktop" : "carbon-studio.desktop",
    linuxWmClass: isDevelopment ? "carbon-studio-dev" : "carbon-studio",
