...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Carbon Studio (Dev)" : "Carbon Studio (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.carbonstudio.app.dev.${devBundleIdSuffix || "local"}`
  : "com.carbonstudio.app";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["carbonstudio-dev"] : ["carbonstudio"];
